...
//  				 log.info("parallelize {}...", podquarti)
//  				 System.out.println("parallelize " + podquarti)
  				 val rdd = sc.parallelize(misure)
  				 
  				    val dfQS1 = sqlCtx.createDataFrame(rdd, schemaQuartiCreaFlusso)
//							log.info("creazione DataFrame schema quarti {} OK", podquarti)
...
//							 System.out.println("insert misure quarti OK " + podquarti)
				 }
